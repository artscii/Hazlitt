...
const records=[
 {id:'a',name:'Phone examination',countries:['Kenya'],publicationYear:'2024',outcome:'Sensitivity 91%.',originalTitle:'Évaluation clinique'},
 {id:'b',name:'Slide study',countries:['Kenya'],publicationYear:'2023',outcome:'Digital cytology with sensitivity 94%.'},
 {id:'c',name:'Screening',countries:['China'],publicationYear:'2024',outcome:'Sensitivity 99%.'},
 {id:'d',name:'Review',countries:['Kenya'],publicationYear:'',date:'Reviewed 2024',outcome:'Sensitivity 81%.'},
];
