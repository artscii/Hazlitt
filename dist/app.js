// Atlas v1.1.3 — Bombo is the default selected project and initial map location.
...
// v1.1.3: filter visible profiles without rebuilding cards or moving keyboard focus.
...
// v1.1.3: mark matches in text nodes only, preserving links and profile markup.
...
// v1.1.3: open with Bombo selected, while preserving the shared coastal marker.
...
// v1.1.3: native search clearing and restored browser state also reset all results.
