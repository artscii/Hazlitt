// Atlas v1.2.2 — Bombo is the default selected project and initial map location.
...
// v1.2.2: filter visible profiles without rebuilding cards or moving keyboard focus.
...
// v1.2.2: mark matches in text nodes only, preserving links and profile markup.
...
// v1.2.2: open with Bombo selected, while preserving the shared coastal marker.
...
// v1.2.2: native search clearing and restored browser state also reset all results.
...
// v1.2.2: normal openings begin at the page top; explicit anchors keep their destination.
if(!location.hash){
...
// v1.2.2: keep search results, map coverage and the first result in sync.
