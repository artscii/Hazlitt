...
const searchSetting=document.createElement('label');searchSetting.innerHTML='<input type="checkbox" id="config-qmd-enabled"> Enable QMD semantic search <small>Turn off to use keyword search only and hide the cloud indicator. Applies when visitors reload the Atlas.</small>';configForm.insertBefore(searchSetting,configForm.firstChild);const qmdEnabled=$('#config-qmd-enabled');
